...
export const TRACKS: MusicTrack[] = [
  {
    ...
    duration: '43:11',
    artworkGradient: 'linear-gradient(145deg, #4fb8f5 0%, #3d8ecf 55%, #7a8ce8 100%)',
  },
  {
    key: 'chuanshao-1',
    title: '串烧 One',
    ...
    duration: '38:27',
    artworkGradient: 'linear-gradient(145deg, #5fa8f0 0%, #4a7fd6 50%, #8f7cff 100%)',
  },
  {
    key: 'chuanshao-2',
    title: '串烧 Two',
    ...
    duration: '35:06',
    artworkGradient: 'linear-gradient(145deg, #3fb8d4 0%, #2ea0b8 50%, #5b9de6 100%)',
  },
  {
    key: 'chuanshao-3',
    title: '串烧 Three',
    ...
    duration: '36:00',
    artworkGradient: 'linear-gradient(145deg, #6fc4f7 0%, #56a0ea 45%, #a08cff 100%)',
  },
];
