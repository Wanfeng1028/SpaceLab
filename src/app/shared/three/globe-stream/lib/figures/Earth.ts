...
class CreateEarth {
  ...
  constructor(store: Store) {
    ...
    this._store = store;
    this._config.earth.material = this.normalizeMaterialKey(this._config.earth.material) as any;
  }
  ...
  createSphereMesh() {
    ...
    const materialCreator = this.materialMap[materialKey] || this.materialMap.default;
