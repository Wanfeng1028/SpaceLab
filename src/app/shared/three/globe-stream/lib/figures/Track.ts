import { Color, MathUtils, Mesh, ShaderMaterial, SphereGeometry, Vector3 } from 'three';
...
export default class Track {
  ...
  initImpacts() {
    for (let i = 0; i < this.maxImpacts; i++) {
      this.impacts.push({
        impactPosition: new Vector3().random().subScalar(0.5).setLength(this.radius), // 随机冲击波位置
