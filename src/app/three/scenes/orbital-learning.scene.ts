...
export class OrbitalLearningScene {
    ...
    const mat = new ShaderMaterial({
      ...
      fragmentShader: `
        ...
        void main() {
          ...
          gl_FragColor = vec4(coreColor * intensity * 1.5, intensity);
        }
      `,
    ...
    const mat = new ShaderMaterial({
      ...
      fragmentShader: `
        ...
        void main() {
          ...
          gl_FragColor = vec4(vec3(1.0), alpha * twinkle * 0.6);
        }
      `,
      uniforms: { uTime: { value: 0 } },
    });
  ...
  private animate(): void {
    ...
    this.constellationLines.forEach((line, i) => {
      const pulse = Math.sin(elapsed * 2.0 + i * 0.5) * 0.15 + 0.3;
